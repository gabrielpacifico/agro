...
<head>
    ...
    <title>Cadastro de Ovinos</title>
...
<body id="cadastro">
    ...
    <section class="home-section">
        <div class="text">Cadastro | <strong> Ovinos </strong> </div>
        ...
        <div class="form-area bootstrap-iso">
            <form action="insert-ovinos.php" method="POST">

                <div class="input-group mb-3">
                    <span class="input-group-text">Espécie</span>
                    <input type="text" class="form-control" name="especie" value="Ovinos" id="input" readonly required>
                </div>
