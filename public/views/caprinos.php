    ...
    <section class="table bootstrap-iso" id="table">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM animais WHERE especie = 'Caprinos' ORDER BY data_vacina ASC";
                ...
                ?>
                    <tr onclick="location.href='info-caprino.php?id=<?= $id ?>&ref_animal=<?= $ref_animal ?>'" class="link-table">
